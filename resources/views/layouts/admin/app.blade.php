                ...
                <li class="nav-item dropdown notification-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                        ...
                        <div class="notification-scroll">
                            ...
                            <div class="mt-2 drodpown-title notification">
                    ...
                    <div class="row layout-top-spacing">
                                    ...
                                    <div class="task-action">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle" href="#" role="button"
                                                id="renvenue" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            ...
                            <div class="widget widget-activity-four">
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="mx-auto mt-container-ra">
                                    ...
                                    <div class="tm-action-btn">
                                        <button class="btn"><span>View All</span> <svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            ...
                            <div class="widget widget-wallet-one">
                                ...
                                <div class="mb-3 text-center wallet-info">

                                    <p class="mb-3 wallet-title">Total Balance</p>

                                    <p class="mb-3 total-amount">$ 26,177.88</p>

                                    <a href="#" class="wallet-text"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <div class="text-center wallet-action d-flex justify-content-around">
                                ...
                                <ul class="list-group list-group-media">
                                    <li class="list-group-item ">
                                        <div class="media">
                                            <div class="me-3">
                                                <img alt="avatar" src="../src/assets/img/netflix.svg"
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            <div class="me-3">
                                                <img alt="avatar" src="../src/assets/img/apple-app-store.svg"
                                                    class="img-fluid rounded-circle">
                                            </div>
                                            <div class="media-body">
                                ...
                                <button class="mt-3 btn btn-secondary w-100">View Transaction History</button>
                                        ...
                                        <table class="table table-scroll">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-content"><span
                                                                class="discount-pricing">$60.09</span></div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-content"><span
                                                                class="discount-pricing">$47.09</span></div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-content"><span
                                                                class="discount-pricing">$20.00</span></div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-content"><span
                                                                class="discount-pricing">$33.00</span></div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="td-content"><span
                                                                class="discount-pricing">$26.04</span></div>
                                                    </td>
                                                    <td>
