   ...
   <main class="{{ $RouteName == 'client.ProductIndex' ? 'container-fluid px-0 px-lg-5 mt-4' : '' }}">
    ...
    <div class="py-2 bg-white fixed-bottom d-flex justify-content-around d-md-none border-top">
        <a href="#" class="gap-1 text-black d-flex justify-content-center align-items-center flex-column">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-house-fill"
                viewBox="0 0 16 16">
                <path
        ...
        <a href="#" class="gap-1 text-secondary d-flex justify-content-center align-items-center flex-column">
            <svg width="25" height="25" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
