...
<body>
    ...
    @if ($RouteName != 'client.Shipping.index')
        <!-- Header -->
        <header class="header">
                ...
                <div class="d-flex">
                    ...
                    <div class="header__right w-50 d-flex align-items-center">
                        <div class="header__logo-container d-md-none d-sm-none">
                            <img class="header__logo" src="/client/assets-v2/images/full-horizontal.svg" alt="" />
                        </div>
                    ...
                    <!-- left -->
                    <div class="header__left w-50 d-flex justify-content-end align-items-center d-md-none d-sm-none">
                ...
                <nav class="mt-4 navbar d-flex align-items-center d-sm-none d-md-none">
                    <div class="w-75">
                        <ul class="navbar__item-container d-flex align-items-center">
                            ...
                            <li class="navbar__item">
                                <a href="#" class="ml-4 d-flex align-items-center">
                                    <i class="ml-2 fa-light fa-badge-percent"></i>
                                    شگفت انگیز ها
                                </a>
                            </li>
                            <li class="navbar__item">
                                <a href="#" class="ml-4 d-flex align-items-center">
                                    <i class="ml-2 fa-light fa-basket-shopping"></i>
                                    سوپرمارکت
                                </a>
                            </li>
                            <li class="navbar__item">
                                <a href="#" class="ml-4"><i class="ml-2 fa-light fa-gift-card"></i>
                                    کارت هدیه
                                </a>
                            </li>
                            <li class="navbar__item">
                                <a href="#" class="ml-4 d-flex align-items-center">
                                    <i class="ml-2 fa-light fa-fire"></i>
                                    پروفروش ترین ها
                                </a>
                            </li>
                            <li class="navbar__item">
                                <a href="#" class="ml-4 d-flex align-items-center">
                                    <i class="ml-2 fa-light fa-hundred-points"></i>
    ...
    @if ($RouteName != 'client.Shipping.index')
        ...
        <footer class="footer">
            <div class="container">
                <div class="mt-5 mb-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="footer__logo-container">
                            <img class="footer__logo" src="/client/assets-v2/images/full-horizontal.svg" alt="" />
                        </div>
                        <a href="#" class="footer__scrollToTop-btn">بازگشت به بالا
                ...
                <div class="mt-5 mb-5 d-flex align-items-center justify-content-around footer-features d-sm-none d-md-none">
                    <a href="#" class="d-block footer-features__item">
                        <div class="footer-features__img-container">
                            <img src="/client/assets-v2/images/feature-1.svg" class="footer-features__img" alt="" />
                        </div>
                        <p class="footer-features__title">اﻣﮑﺎن ﺗﺤﻮﯾﻞ اﮐﺴﭙﺮس</p>
                    </a>
                    <a href="#" class="d-block footer-features__item">
                        <div class="footer-features__img-container">
                            <img src="/client/assets-v2/images/feature-2.svg" class="footer-features__img" alt="" />
                        </div>
                        <p class="footer-features__title">امکان پرداخت در محل</p>
                    </a>
                    <a href="#" class="d-block footer-features__item">
                        <div class="footer-features__img-container">
                            <img src="/client/assets-v2/images/feature-3.svg" class="footer-features__img" alt="" />
                        </div>
                        <p class="footer-features__title">۷ روز ﻫﻔﺘﻪ، ۲۴ ﺳﺎﻋﺘﻪ</p>
                    </a>
                    <a href="#" class="d-block footer-features__item">
                        <div class="footer-features__img-container">
                            <img src="/client/assets-v2/images/feature-4.svg" class="footer-features__img" alt="" />
                        </div>
                        <p class="footer-features__title">هفت روز ضمانت بازگشت کالا</p>
                    </a>
                    <a href="#" class="d-block footer-features__item">
                        <div class="footer-features__img-container">
                            <img src="/client/assets-v2/images/feature-5.svg" class="footer-features__img" alt="" />
                        </div>
                ...
                <div class="row footer__block">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        ...
                        <a class="mb-3 d-block" href="#">اتاق خبر دیجی‌کالا</a>
                        <a class="mb-3 d-block" href="#">فروش در دیجی‌کالا</a>
                        <a class="mb-3 d-block" href="#">فرصت‌های شغلی</a>
                        <a class="mb-3 d-block" href="#">گزارش تخلف در دیجی‌کالا</a>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 footer-contact-us">
                        ...
                        <div
                            class="mt-3 mb-3 footer-contact-us_itm-container d-flex align-items-center justify-content-around">
                        ...
                        <div class="footer-form">
                            ...
                            <div class="mt-3 footer-form__container d-flex justify-content-between align-items-center">
                                <input class="footer-form__email" type="text" placeholder="راهنمای خرید از دیجی‌کالا" />
                                <button class="footer-form__btn">ثبت</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="mt-5 mb-5 footer-apps d-flex align-items-center justify-content-between">
                    <div class="d-flex footer-apps__right align-items-center">
                        <div class="footer-apps__img-container">
                            <img class="footer-apps__img" src="/client/assets-v2/images/footerlogo2.png" alt="" />
                        </div>
                    ...
                    <div class="footer-apps__left d-flex">
                        <a href="#" class="footer-apps__item-container">
                            <img class="footer-apps__img" src="/client/assets-v2/images/sib-app.svg" alt="" />
                        </a>
                        <a href="#" class="footer-apps__item-container">
                            <img class="footer-apps__img" src="/client/assets-v2/images/coffe-bazzar.svg" alt="" />
                        </a>
                        <a href="#" class="footer-apps__item-container">
                            <img class="footer-apps__img" src="/client/assets-v2/images/myket.svg" alt="" />
                        </a>
                        <a href="#" class="footer-apps__item-container">
                            <img class="footer-apps__img" src="/client/assets-v2/images/more.svg" alt="" />
                        </a>
                    </div>
                </div>

                <div class="mt-5 mb-5 d-flex footer-trust">
                    ...
                    <div class="mr-5 d-flex align-items-center footer-trust__left w-50 justify-content-end">
                        <a href="#" class="footer-trust__item"><img src="/client/assets-v2/images/rezi.webp" alt=""
                                class="footer-trust__img" /></a>
                        <a href="#" class="footer-trust__item"><img src="/client/assets-v2/images/rezi.png" alt=""
                                class="footer-trust__img" /></a>
                        <a href="#" class="footer-trust__item"><img src="/client/assets-v2/images/rezi.png" alt=""
                                class="footer-trust__img" /></a>
                    </div>
