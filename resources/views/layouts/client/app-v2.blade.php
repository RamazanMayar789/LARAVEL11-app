  ...
  <body>
        ...
        <nav class="mt-4 navbar d-flex align-items-center d-sm-none d-md-none">
          <div class="w-75">
            <ul class="navbar__item-container d-flex align-items-center">
              ...
              <li class="navbar__item">
                <a href="#" class="ml-4"
                  ><i class="ml-2 fa-light fa-gift-card"></i>
                  کارت هدیه
                </a>
              </li>
              <li class="navbar__item">
    ...
    <footer class="footer">
      <div class="container">
        ...
        <div class="row footer__block">
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 footer-contact-us">
            ...
            <div class="footer-form">
              ...
              <div
                class="mt-3 footer-form__container d-flex justify-content-between align-items-center"
              >
                <input
        ...
        <div
          class="mt-5 mb-5 footer-apps d-flex align-items-center justify-content-between"
        >
        ...
        <div class="mt-5 mb-5 d-flex footer-trust">
          ...
          <div
            class="mr-5 d-flex align-items-center footer-trust__left w-50 justify-content-end"
          >
