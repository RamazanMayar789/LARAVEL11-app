                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($stories as $item)
                                <tr>
                                    <td>
                                  {{ $loop->iteration + ($stories->first() ? $stories->first()->id : 0) - 1 }}


                                    </td>
                                    <td>{{ $item->title }}</td>
                                    <td><img src="/stories/thumbnail/{{$item->thumbnail}}" width="50" alt="not" ></td>
                                    <td>
                                        <button data-story="/stories/story/{{$item->story}}" type="button" class="mr-2 btn btn-primary"
