                        ...
                        <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                            <div class="mb-4 row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" wire:model.blur='name' id="name" name="name" placeholder="لطفا نام زون خود را وارد کنید">
                                </div>
                            </div>
                            @error('name')
                            ...
                            @enderror
                             <div class="mb-4 row">
                                <div class="col-sm-12">
                                   ...
                                   <select id="country" placeholder="انتخاب کشور" class="form-control" wire:model="countryId" name="countryId" wire:ignore>
