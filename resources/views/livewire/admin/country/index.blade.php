                                                ...
                                                @foreach ($countries as $country )
                                                  <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="javascript:void(0);" wire:click="edit({{ $country->id }})" class="action-btn btn-edit text-bg-danger bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
