     ...
     <footer class="pt-5 mt-5 border-top">
        <div class="container-fluid px-lg-5">
            ...
            <div class="w-100 d-flex d-lg-none justify-content-center">
                <button class="bg-transparent border-0 text-info fs-9" onclick="window.scrollTo(0,0)">
                    بازگشت به بالا
                    <svg width="14" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke-width="1.5" stroke="currentColor" class="me-2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
                    </svg>
                </button>
            </div>
            ...
            <!-- mobile call support -->
            <div class="mt-4 d-flex d-lg-none align-items-center justify-content-between">
                <div class="gap-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="mt-2 fs-8 fw-bold">تماس با پشتیبانی</p>
                    </div>
                </div>
            ...
            <div class="mt-4 d-flex d-lg-none align-items-center justify-content-between">
                <div class="gap-2 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="mt-2 fs-8 fw-bold">اپلیکیشن دیجی‌کالا</p>
                    </div>
                </div>
            ...
            <!-- mobile faq -->
            <div class="mt-4 accordion accordion-flush d-block d-lg-none" id="accordionFlushExample">
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed fs-9" type="button" data-bs-toggle="collapse"
            ...
            <div class="container flex-wrap gap-5 mt-5 d-none d-lg-flex align-items-center justify-content-center">
            ...
            <div class="my-5 d-none d-lg-flex row">
                <div class="col-12 col-md-6 col-lg-3">
                    <h6 class="my-3">با دیجی‌کالا</h6>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">اتاق خبر دیجی کالا</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">فروش در دیجی کالا</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">فرصت های شغلی</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">گزارش تخلف در دیجی کالا</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">تماس با دیجی کالا</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">درباره دیجی کالا</p>
                    </a>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">پاسخ به پرسش های متداول</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">رویه های بازگرداندن کالا</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">شرایط استفاده</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">حریم خصوصی</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">گزارش باگ</p>
                    </a>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">نحوه ثبت سفارش</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">رویه ارسال سفارش</p>
                    </a>
                    <a href="#" class="text-black-50 fs-7">
                        <p class="my-2">شیوه های پرداخت</p>
                    </a>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <form action="#" method="post">
                        <input type="email" name="email" id="email" placeholder="ایمیل شما"
                            class="px-3 py-2 border rounded-2 fs-8" />
            ...
            <div class="p-2 d-none d-lg-flex row flex-column flex-lg-row align-items-center justify-content-between p-lg-4 rounded-3"
                style="background-color: #3c4b6d">
                <div class="gap-3 col-6 d-flex align-items-center">
                    <img width="60" src="/client/assets/footer/footerlogo2.webp" alt="icondigi" />
                    <h5 class="text-white">دانلود اپلیکیشن دیجی کالا</h5>
                </div>

                <div class="flex-wrap gap-5 col-6 d-flex align-items-center">
                    <div>
            ...
            <div class="mt-5 d-none d-lg-flex row">
                <div class="col-12 col-lg-6">
                    <h5 class="my-3 text-secondary">فروشگاه اینترنتی دیجی کالا، بررسی، انتخاب و خرید آنلاین</h5>
                    <p class="text-wrap text-black-50">
                        اینترنتی مطمئن، نیازمند فروشگاهی است که بتواند کالاهایی متنوع، باکیفیت و دارای قیمت مناسب را در
                        مدت زمانی
                        کوتاه به دست مشتریان خود برساند و ضمانت بازگشت کالا هم داشته باشد؛ ویژگی‌هایی که فروشگاه
                        اینترنتی
                ...
                <div
                    class="flex-wrap gap-3 mt-3 col-12 col-lg-6 d-flex align-items-center justify-content-center gap-lg-5">
            ...
            <!-- copyrights -->
            <p class="text-center fw-light my-lg-5 copyright text-secondary">
                برای استفاده از مطالب دیجی‌کالا، داشتن «هدف غیرتجاری» و ذکر «منبع» کافیست. تمام حقوق اين وب‌سايت نیز
                برای شرکت
                نوآوران فن آوازه (فروشگاه آنلاین دیجی‌کالا) است.
            </p>
        </div>

        <div class="px-5 subBrand d-lg-block d-none bg-secondary-subtle">
