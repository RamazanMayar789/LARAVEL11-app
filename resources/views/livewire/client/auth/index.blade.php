    ...
    <div>
        ...
        <div class="mb-4 row">
            <div class="col-6 d-flex justify-content-center">
                <button class="gap-3 px-3 py-2 d-flex align-content-center btn btn-outline-secondary"
        ...
        <p class="fs-8">
            ورود شما به معنای پذیرش <a href="/client#">شرایط دیجی کالا</a> و
            <a href="/client#">قوانین حریم خصوصی </a>است
        </p>
    </div>
</div>
