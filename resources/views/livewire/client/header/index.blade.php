    ...
    <header class="container-fluid border-bottom" id="desktop-main-header">
        ...
        <div class="py-4 row mx-lg-4">
            <div class="col-12 col-lg-8 d-flex align-items-center column-gap-2">
                ...
                <div class="px-4 py-1 rounded bg-secondary-subtle searchInput d-flex align-items-center">
                    <!-- search icon -->
                    <div>
                        <svg class="text-secondary" width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <!-- mobile search -->
                    <input type="text" style="width: 57px" class="py-2 bg-transparent border-0 d-block d-lg-none"
                        placeholder="جستجو در" readonly />
                    <!-- desktop search input -->
                    <button type="button"
                        class="my-2 bg-transparent border-0 d-none d-lg-block fs-8 text-secondary w-100 text-end"
                        data-bs-toggle="modal" data-bs-target="#desktopSearchBox">
                        جستجو
                    </button>

                    <img src="/client/assets/digi.svg" alt="digikala logo" width="80" class="d-block d-lg-none" />
                </div>

                <!-- Mobile Modal Search Box -->
                <div id="mSearchBox" class="pt-4 bg-white w-100 h-100 justify-content-center align-items-start">
            ...
            <div class="cart-container">
                <div class="cart-icon">
                <svg width="28" height="28" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                </svg>
                    <span class="cart-badge" id="cart-count">{{ $cart }}</span>
                </div>
            </div>
                <span>
        ...
        <div class="modal" id="desktopSearchBox" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="gap-2 mx-0 modal-header border-bottom border-info justify-content-start">
                        ...
                        <input type="text" placeholder="جستجو" id="searchInput"
                            class="py-2 mx-0 border-0 form-control fs-9 text-secondary w-100 pe-2" />
                    ...
                    <div class="modal-body">
                        ...
                        <div id="clean">
                            <!-- ads banner -->
                            <a href="#">
                                <img src="/client/assets/header/headerAds.webp" alt="ads" class="w-100 rounded-3" />
                            </a>
                            ...
                            <div class="my-4">
                                ...
                                <!-- search -->
                                <div class="mt-2 swiper myHeaderSearchSwiper">
                                    <div class="py-2 swiper-wrapper">
                                        <div class="swiper-slide">
                                            <button type="button"
                                                class="gap-2 px-2 py-2 bg-white border d-flex flex-nowrap align-items-center rounded-5">
        ...
        <!-- === Menu and Loaction === -->
        <div class="mt-2 d-none d-lg-flex row">
            <div class="col-10">
                <ul class="gap-3 d-flex align-items-center">
                    ...
                    <li class="overflow-hidden d-flex flex-column">
                        <a href="#" class="gap-1 d-flex align-items-center text-black-50">
                            <span>
                        ...
                        <span class="border-bottom border-danger w-100 navLinkHoverAnimation"></span>
                    </li>
                    <li class="overflow-hidden d-flex flex-column">
                        <a href="#" class="gap-1 d-flex align-items-center text-black-50">
                            <span>
