<div>
    <section class="d-none d-lg-block py-lg-5 mx-lg-5 border-top border-bottom border-3">
        <h6 class="mt-3 mt-lg-5 fw-bold">
            <span class="pb-3 border-2 border-bottom border-danger">فروشندگان </span>این کالا
        </h6>
        <!-- sellers shop -->
        <div id="sellers">
            <!-- seller no.1 -->
            <div class="flex-wrap p-3 w-100 rounded-3 row flex-lg-nowrap justify-content-around">
                <!-- Icon,ShopName,Score -->
                <div class="col col-lg-2">
                    <div class="gap-3 d-flex">
                        ...
                        <div>
                            ...
                            <!-- shop score -->
                            <div class="gap-2 my-3 d-flex align-content-center">
                ...
                <div class="col col-lg-4">
                    <div class="flex-wrap d-flex align-items-center justify-content-between">
                        ...
                        <div class="gap-1 d-flex align-items-center">
                            ...
                            <p class="px-2 py-1 text-white fs-8 bg-danger rounded-5 fw-bold">6%</p>
                        </div>
                        <!-- add to card -->
            ...
            <div class="flex-wrap p-3 w-100 rounded-3 row flex-lg-nowrap justify-content-around">
                <!-- Icon,ShopName,Score -->
                <div class="gap-3 col col-lg-2 d-flex">
                    <!-- icon -->
