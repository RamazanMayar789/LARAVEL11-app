...
<section id="details">
        <ul class="px-0 swiper myProductFeatureSwiper nav nav-tabs px-lg-auto" id="nav">
            <div class="swiper-wrapper">
                ...
                <li class="border-0 swiper-slide nav-item fs-8 d-flex flex-column" data-target="#question-content">
                ...
                <div class="content-section row">
                    ...
                    <div class="col col-lg-9">
                        ...
                        <div class="gap-1 d-none d-lg-flex align-items-center">
                            <svg width="16" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            <button type="button" class="bg-transparent border-0" data-bs-toggle="tooltip"
                                ...
                                <svg width="15" height="15" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-secondary">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
                                </svg>
                            </button>
                        ...
                        <div class="gap-2 my-4 d-flex align-items-center">
                            <button style="width: 8%" type="button"
                                class="p-0 m-0 bg-transparent border opacity-50 rounded-2" data-bs-toggle="modal"
                        ...
                        <button class="bg-transparent border-0 d-none d-lg-block text-info fs-8" style="width: 8%"
                        ...
                        <div class="mt-4 d-none d-lg-block">
                            <div class="gap-2 d-flex">
                                <button type="button" class="px-3 py-2 border btn rounded-5 fs-8 fw-bold">کیفیت و
                                    کارایی</button>
                                <button type="button" class="px-3 py-2 border btn rounded-5 fs-8 fw-bold">قیمت و ارزش
                                    خرید</button>
                                <button type="button" class="px-3 py-2 border btn rounded-5 fs-8 fw-bold">شباهت یا
                                    مغایرت</button>
                            </div>
                            <p class="mt-3 fs-9 text-secondary">این دسته‌بندی توسط هوش مصنوعی انجام شده و ممکن است دقیق
                                نباشد</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="my-4 d-flex align-items-center justify-content-between">
                                ...
                                <button class="bg-transparent border-0">
                                    <svg width="18" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="text-secondary">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <!-- comment text -->
                            <div class="my-4">
                                <h6 class="mb-3 fw-bold">گوشی خاص و باحال</h6>
                                <p>
                                    گوشی ناتیفنگ فون جنس بدنه و پشت گوشی خیلی خوبه کیفیت ال ای دی های نورش هم خوبه اما این
                                    گوشی حسی که
                                    بهت میده انگار گوگل این گوشی رو ساخته و نه شرکت ناتینگ فون ، متریال استفاده شده همه
                                    واقعا عالی
                                    هستش ، بعلاوه اینکه بنظرم رابط کاربری و .. باید توسط ناتینگ فون بهینه بشه . در اخر
                                    بعنوان یک گوشی
                                    ۲۰ میلیونی بدون شارژر خوبه ولی برای خرید شارژر و گلس و قاب مناسب هم باید حدودا ۳ ۴ ت پول
                                    هزینه
                            ...
                            <div class="mt-4 d-flex align-items-center justify-content-between">
                                ...
                                <div class="gap-3 d-flex align-items-center">
                                    <!-- like -->
                                    <button type="button"
                                        class="gap-2 bg-transparent border-0 d-flex align-items-center text-secondary">
                                        <p class="fs-8">2</p>
                        ...
                        <div class="modal-body">
                            <div class="d-flex align-items-start justify-content-center">
                                <div>
                                    ...
                                    <p class="mt-4 fs-9 text-secondary fw-light">30 مرداد 1403</p>
                                </div>
                                <h5 class="px-5 fs-7">گوشی موبایل ناتینگ مدل Phone 2a ظرفیت 256 گیگابایت رم 12 گیگابایت</h5>
                            </div>
                            <hr />
                            ...
                            <div class="mt-3 border form-group d-flex align-items-center justify-content-between rounded-3">
                                <input type="text" id="inputTextPositive" class="border-0 form-control" />
                                <button id="addButtonPositive" class="m-2 bg-transparent border-0 fs-3">+</button>
                            </div>
                            ...
                            <div class="mt-3 border form-group d-flex align-items-center justify-content-between rounded-3">
                                <input type="text" id="inputTextNegative" class="border-0 form-control" />
                                <button id="addButtonNegative" class="m-2 bg-transparent border-0 fs-3">+</button>
                            </div>
                            ...
                            <button type="button" class="mt-3 btn btn-danger w-100">ثبت امتیاز و دیدگاه</button>
                    ...
                    <div class="d-none d-lg-block col-lg-9">
                        ...
                        <div>
                            ...
                            <div class="pt-3 mt-4 border-top">
                                <button type="button" class="bg-transparent border-0 text-info fs-8">
                                    ثبت پاسخ جدید
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <button id="submitButton" class="mt-2 btn btn-danger w-100" disabled>ثبت پرسش</button>
