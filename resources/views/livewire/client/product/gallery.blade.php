<div class="col col-lg-4">
    ...
    <div class="flex-row-reverse d-none d-lg-flex row flex-lg-row align-items-start">
        <div class="gap-3 col col-lg-1 d-flex flex-lg-column">
            <!-- like -->
            <button class="bg-transparent border-0">
                <svg width="30" heigth="30" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <!-- Comparison -->
            <button class="bg-transparent border-0">
                <svg width="30" height="30" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-vr"
                    viewBox="0 0 16 16">
                    <path
    ...
    <div>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="bg-transparent border-0 modal-content gallery">
