 <div id="comment-content" class="content-div mx-lg-5 {{ $activeTab == 4 ? 'active' : '' }}" wire:ignore.self>
                            ...
                            <div class="mt-4 d-flex align-items-center justify-content-between">
                                ...
                                <div class="gap-3 d-flex align-items-center">
                                    ...
                                    <div class="loader vote-loader" wire:loading
                                        wire:target="setVote('like',{{ $item->id }}"></div>
                                    ...
                                    <div class="loader vote-loader" wire:loading
                                        wire:target="setVote('dislike',{{ $item->id }})"></div>
        ...
        <!-- comment modal -->
        <div class="modal fade" wire:ignore.self id="commentModal" tabindex="-1" aria-labelledby="commentModalLabel"
            aria-hidden="true">
                    ...
                    <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model='title' type="text" name="title" class="form-control fs-8"
                                    id="commentTitle" />
                            </div>
                            @error('title')
                            ...
                            <div
                                class="mt-3 border form-group d-flex align-items-center justify-content-between rounded-3">
                                <input type="text" wire:model='InputPositive' id="inputTextPositive"
                                    class="border-0 form-control" />
                                <button type="button" id="addButtonPositive" wire:click="addItem('positive')"
                                    class="m-2 bg-transparent border-0 fs-3">+</button>
                            </div>
                            @error('InputPositive')
                                <div class="mt-2 alert alert-danger">{{ $message }}</div>
                            @enderror
                            <ul id="positiveList" class="p-0 list-group">
                                ...
                                @foreach ($positiveItems as $index => $item)
                                    <li
                                        class="my-2 border-0 list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <button wire:click="removeItem('positive',{{ $index }})"
                                            class="bg-transparent border-0 deleteButton">
                            ...
                            <div
                                class="mt-3 border form-group d-flex align-items-center justify-content-between rounded-3">
                                <input wire:model='InputNegative' type="text" id="inputTextNegative"
                                    class="border-0 form-control" />
                                <button type="button" id="addButtonNegative" class="m-2 bg-transparent border-0 fs-3"
                                    wire:click="addItem('Negative')">+</button>
                            </div>
                            ...
                            <div class="mt-5">
                                ...
                                <textarea wire:model='comment' name="comment" class="form-control"
                            ...
                            @if ($submitsuccessalert)
                                    <div class="mt-2 alert alert-success">دیدگاه شما با موفقعیت ثبت شد. بعد از تایید مدیریت
                                        نمایش داده میشود.</div>
